...
import 'package:awsomeapp/screens/t4Sb.dart';
import 'package:awsomeapp/screens/t4_withModel.dart';
...
Future main() async {
  ...
  runApp(MaterialApp(
    title: "Flutter App",
    home: Constants.prefs.getBool("LoggedIn") == true ? TaskWithModel() : LoginPage(),
    theme: ThemeData(
